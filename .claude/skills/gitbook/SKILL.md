---
name: gitbook
description: Reference for editing GitBook documentation as markdown files outside the GitBook UI (Git-synced repos, IDEs, CLI). Use when writing or maintaining GitBook content — frontmatter and page layout, SUMMARY.md and .gitbook.yaml structure, custom blocks (tabs, hints, steppers, cards, columns, expandables), variables and expressions, or OpenAPI specs. Triggers on mentions of GitBook, .gitbook.yaml, SUMMARY.md, or editing docs in the docs.clashperk.com workspace.
version: 0.1.0
---
