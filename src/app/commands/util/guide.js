	...
	async exec(message) {
		...
		const embed = this.client.util.embed()
			...
			.setDescription([
				...
				'',
				'**Last Online Board**',
				`\`${prefix}setup onlineboard <#clanTag>\``,
				'',
				...
				'',
				'**Clan Games Board**',
				`\`${prefix}setup gameboard <#clanTag>\``,
				'',
				'**Donation Log**',
				`\`${prefix}setup donationlog <#clanTag>\``,
				'',
				'**Live War Board**',
				`\`${prefix}setup clanwarlog <#clanTag>\``,
				'',
				'**Member Log**',
				`\`${prefix}setup memberlog <#clanTag> [@role]\``,
				'',
				'**🔸 Step 2 : Linking Clan**',
				`\`${prefix}link <#clanTag>\``,
				'',
