				...
				if ((data.clan && data.clan.tag === clanTag) || (data.opponent && data.opponent.tag === clanTag)) {
					...
					if (data.state === 'warEnded') {
						...
						collection.push([[
							...
							`\`\u200e${clan.stars.toString().padEnd(10, ' ')} \u200f\`\u200e \u2002 ${emoji.star} \u2002 \`\u200e ${opponent.stars.toString().padStart(10, ' ')}\u200f\``,
							`\`\u200e${this.attacks(clan.attacks, data.teamSize).padEnd(10, ' ')} \u200f\`\u200e \u2002 ${emoji.attacksword} \u2002 \`\u200e ${this.attacks(opponent.attacks, data.teamSize).padStart(10, ' ')}\u200f\``,
							`\`\u200e${this.destruction(clan.destructionPercentage).padEnd(10, ' ')} \u200f\`\u200e \u2002 ${emoji.fire} \u2002 \`\u200e ${this.destruction(opponent.destructionPercentage).padStart(10, ' ')}\u200f\``
						]]);
					}
					if (data.state === 'inWar') {
						stars += clan.stars;
